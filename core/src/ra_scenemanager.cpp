...
void SceneManager::Initialize()
{
	...
	#pragma region MainScene
	{
		...
		testObject->Initialize(mainSceneRoot, GetVariableName(testObject), "dragon.obj", "texture.jpg", true, true);
		...
		testObject2->Initialize(mainSceneRoot, GetVariableName(testObject2), "dragon(2).obj", "texture(2).jpg", true, true);
